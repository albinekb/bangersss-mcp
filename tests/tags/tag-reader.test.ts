...
describe('Tag reader', () => {
  ...
  it('reads title and artist', async () => {
    const mp3 = createMinimalMp3({ title: 'Test Track', artist: 'Test Artist' });
  ...
  it('reads genre and album', async () => {
    const mp3 = createMinimalMp3({ title: 'T', artist: 'A', genre: 'House', album: 'Summer Mix' });
  ...
  describe('batchReadTags', () => {
    it('reads multiple files', async () => {
      ...
      await fs.writeFile(file1, createMinimalMp3({ title: 'Batch One', artist: 'Artist A' }));
      await fs.writeFile(file2, createMinimalMp3({ title: 'Batch Two', artist: 'Artist B' }));
