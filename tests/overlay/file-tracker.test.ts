...
describe('FileTracker', () => {
  ...
  it('tracks write operations', () => {
    tracker.track({ type: 'write', path: '/music/track.mp3', data: Buffer.from('hello') });
  ...
  it('tracks rename operations', () => {
    tracker.track({ type: 'rename', path: '/old.mp3', from: '/old.mp3', to: '/new.mp3' });
    const ops = tracker.getOperations();
    expect(ops).toHaveLength(1);
  ...
  it('returns affected paths deduplicated', () => {
    ...
    tracker.track({ type: 'write', path: '/a.mp3', data: Buffer.from('updated') });
    tracker.track({ type: 'rename', path: '/b.mp3', from: '/b.mp3', to: '/c.mp3' });
  ...
  it('filters operations by paths', () => {
    ...
    tracker.track({ type: 'rename', path: '/c.mp3', from: '/c.mp3', to: '/d.mp3' });
