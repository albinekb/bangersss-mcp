...
describe('BPM analysis signal processing', () => {
  ...
  function generateClickTrack(bpm: number, durationSec: number, sampleRate: number): Float32Array {
  ...
  function computeEnvelope(samples: Float32Array, sampleRate: number, frameMs: number): Float32Array {
